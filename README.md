...
* **Convocazione** — la prossima partita (di serie il **giovedì**) con chi c'è e chi no, modificabile da chiunque fino all'ultimo. Mentre arrivano le risposte mostra **chi farà il capitano e chi il formatore con i sì di adesso**: sono il primo e l'ultimo in classifica fra chi ha detto sì, e cambiano se cambiano le risposte (finché i sì sono meno di due valgono quelli di tutta la rosa, e l'app lo dice). La domanda "ci sei?" comincia a girare dal **giorno d'avviso** — di serie la domenica prima — e ti segue in cima a ogni schermata finché non rispondi. Giorno di gioco, giorno d'avviso e orario li cambia chiunque dalla scheda
...
* **Giro dei capitani** — il suggerimento segue sempre la regola della cava: **capitano il primo in classifica, formatore l'ultimo** — ma solo fra chi **non ha ancora fatto né l'uno né l'altro in questo giro**. Quando le squadre sono fatte i due si segnano da soli; chiuso il giro (restano in meno di due liberi) si riparte da tutta la classifica. La scheda in Squadre mostra chi ha già fatto e lascia sistemare la lista a mano, per le partite giocate prima dell'app
